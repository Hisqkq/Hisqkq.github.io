...
<div class="title">Technologies used for the project</div>
...
## Schema of the SCRUM process

Here is a schema of the SCRUM process we followed during the development of the web application:

```mermaid
graph TD
    A["<b style='font-size:18px'>Product Backlog</b>"]
    B["<b style='font-size:14px'>Sprint Planning</b>"]
    C["<b style='font-size:14px'>Sprint Backlog</b>"]
    D["<b style='font-size:14px'>Daily Scrum</b>"]
    E["<b style='font-size:14px'>Sprint Goal</b>"]
    F["<b style='font-size:18px'>Sprint</b>"]
    G["<b style='font-size:14px'>Product Increment</b>"]
    H["<b style='font-size:14px'>Sprint Review</b>"]
    I["<b style='font-size:18px'>Sprint Retrospective</b>"]
    J["<b style='font-size:18px'>Scrum Team</b>"]
    K["<b style='font-size:14px'>Product Owner</b>"]
    L["<b style='font-size:14px'>Scrum Master</b>"]
    M["<b style='font-size:14px'>Developers</b>"]
    N["<b style='font-size:18px'>Users/Clients/Stakeholders</b>"]

    N -->|Provides Feedback| A
    A --> B
    B --> C
    C --> E
    E --> F
    ...
    style C fill:#ffd699,stroke:#333,stroke-width:2px
    style D fill:#ffc266,stroke:#333,stroke-width:2px
    style E fill:#ffad33,stroke:#333,stroke-width:2px
    style F fill:#ff9900,stroke:#333,stroke-width:2px
    style G fill:#e68a00,stroke:#333,stroke-width:2px
    style H fill:#cc7a00,stroke:#333,stroke-width:2px
    style I fill:#b36b00,stroke:#333,stroke-width:2px
    style J fill:#e6ffe6,stroke:#333,stroke-width:2px
    style K fill:#ccffcc,stroke:#333,stroke-width:2px
    style L fill:#b3ffb3,stroke:#333,stroke-width:2px
