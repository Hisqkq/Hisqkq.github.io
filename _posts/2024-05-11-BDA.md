...
<div class="title"> Nous avons utilisés plusieurs fichiers csv de l'INSEE pour extraire les données suivantes : </div>
...
<summary>Résultat de la requête SQL </summary>
...
<details class="details-block" markdown="1">
<summary> Résultat de la requête EXPLAIN </summary>
